    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="bg-gray-900/50 border border-purple-500/20 rounded-lg p-6 hover:bg-gray-800/50 transition-colors">
            <div className="bg-purple-500/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
              <Terminal className="h-6 w-6 text-purple-400" />
            </div>
            <h3 className="text-xl font-bold mb-2">Coding Competitions</h3>
          ...
          <div className="bg-gray-900/50 border border-purple-500/20 rounded-lg p-6 hover:bg-gray-800/50 transition-colors">
            ...
            <h3 className="text-xl font-bold mb-2">Technical Workshops</h3>
            <p className="text-gray-400">
